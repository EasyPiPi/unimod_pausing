...
# 
# bwp1_p3_in <- file.path(root_dir, "outputs/bigwig/p3/PROseq-K562-dukler-treated-SE_plus.bw")
# bwm1_p3_in <- file.path(root_dir, "outputs/bigwig/p3/PROseq-K562-dukler-treated-SE_minus.bw")
# 
